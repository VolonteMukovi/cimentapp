...
urlpatterns = [
    ...
    path('parametres/devises/creer/', views.DeviseCreateView.as_view(), name='articles_devise_create'),
    path('parametres/devises/<int:devise_id>/modifier/', views.DeviseUpdateView.as_view(), name='articles_devise_update'),
    path('parametres/devises/<int:devise_id>/supprimer/', views.DeviseDeleteView.as_view(), name='articles_devise_delete'),
